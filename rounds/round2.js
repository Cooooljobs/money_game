document.addEventListener('DOMContentLoaded', () => {
  ...
  const termsAndDefinitions = [
    { term: '../media/round2img/dollar0.png', definition: '../media/round2img/dollar.png' },
    { term: '../media/round2img/euro0.png', definition: '../media/round2img/euro.png' },
    { term: '../media/round2img/yen0.png', definition: '../media/round2img/yen.png' },
    { term: '../media/round2img/rub0.png', definition: '../media/round2img/rub.png' },
    { term: '../media/round2img/won0.png', definition: '../media/round2img/won.png' },

    // Другие элементы массива
  ];

  const numTermsToShow = 6; // Количество терминов для отображения (измените по необходимости)
  ...
  function createCard(content, className) {
    ...
    image.src = content; // Устанавливаем источник изображения
  
    cardContent.appendChild(image); // Добавляем изображение в карточку
  ...
  function showCompletionMessage() {
    ...
    <h2>Поздравляем!</h2>
    <img src="../media/man/lvl2.png" alt="Level 2" id="level-image" width="200px">
    <div class="progress-text">
      Прогресс: <span id="progress-percentage">28,6%</span>
    </div>
    <p>Вы успешно завершили Раунд 2.<br>Вы можете перейти к следующему этапу.</p>
    <a href="round2_2.html" class="next-round-button">Перейти к следующему этапу</a>
  </div>
    `;
